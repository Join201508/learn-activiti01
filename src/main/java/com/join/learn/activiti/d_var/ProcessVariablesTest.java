...
public class ProcessVariablesTest {
	...
	public void setVariableForTask(){
		...
		/*
		 * 1. taskService.setVariableLocal时act_ru_variable.TASK_ID_有值
		 * 2. local变量，只在当前任务中生效，当前任务complete了，local变量消失
		 */
	...
	public void queryHisVariable(){
		...
		for(HistoricVariableInstance hisVar:list){
			...
			System.out.println(var.getId()+"，"+var.getProcessInstanceId()+"，"+var.getTaskId()+"，"+var.getExecutionId()+"，"+var.getVariableName()+"，"+var.getValue());
		}
	}
}
